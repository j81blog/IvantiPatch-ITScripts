...
<stScript uid="b5d4a516-784a-4311-ac6a-19720e807093">
    ...
    <options>
        <option name="OutputMachineResults" value="false" />
    ...
    <description>
        ...
        <purpose>Downloads the latest Windows Citrix WorkspaceApp version</purpose>
        <inputs>none</inputs>
        <outputs>Latest CitrixWorkspaceApp.exe version</outputs>
    </description>
    <parameters>
        <parameter>
            <name>uri</name>
            <description>The download URL</description>
            <default>'https://downloadplugins.citrix.com/Windows/CitrixWorkspaceApp.exe'</default>
        </parameter>
        <parameter>
            <name>fileName</name>
...
$FileInfo = Get-Item $downloadedFilename
$NewName = '{0}_{1}{2}' -f $FileInfo.BaseName, $FileInfo.FileVersionUpdated.ToString(), $FileInfo.Extension
